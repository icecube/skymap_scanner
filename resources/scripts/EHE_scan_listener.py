...
# python $I3_SRC/realtime_tools/resources/scripts/replayI3LiveMoni.py --varname=eheEvent16Data --pass=skua
...
def incoming_event(topic, event):
    ...
    try:
        ...
        event_id, state_dict = extract_json_message(event, filestager=stagers, cache_dir=event_cache_dir) #, override_GCD_filename="2016_06_03_Run127997.i3")
...
realtime_tools.make_daemon(pidfile='EHE_scan_listener.pid',
                           logfile='EHE_scan_listener.log',
                           topics='eheEvent16Data',
